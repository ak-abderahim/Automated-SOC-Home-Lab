...
*   Structured a POST request in Shuffle that passes the SIEM alert details and VirusTotal reputation reports directly into TheHive to dynamically generate high-priority incident tickets.
*   Configured an SMTP mail server action block to immediately email the on-duty analyst when a new case is generated.
